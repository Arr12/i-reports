...
class CreateDailyReportMaydewisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('daily_report_maydewis', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('daily_report_maydewis');
    }
}
