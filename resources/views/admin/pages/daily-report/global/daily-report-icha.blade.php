...
$(document).ready(function(){
    let url = "{{route('daily-report-global.ichas.data')}}";
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    Global Daily Report Icha
                </h2>
                <ul class="header-dropdown m-r--5">
                    <li class="dropdown">
                        <button id='getDataDaily' class="btn btn-primary" data-href="{{route('api.dailyReport.get')}}?d=icha" role="button" aria-haspopup="true" aria-expanded="false">
